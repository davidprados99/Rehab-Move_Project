        ...
        <div className="min-h-screen bg-gray-50 w-full">
            ...
            <div className="max-w-4xl mx-auto p-6">
                ...
                <header className="mt-5 mb-10 text-center">
                    <h1 className="text-3xl font-bold text-rehab-dark mb-5">Tus citas</h1>
                    <p className="text-lg text-rehab-dark mb-5">Aquí puedes ver y gestionar tus citas con tu fisioterapeuta.</p>
                </header>
